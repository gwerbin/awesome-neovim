...
- [Wishlist](#wishlist)
- [Configuration frameworks](#configuration-frameworks)
- [UI](#ui)
- [Plugin](#plugin)
...
Is there something you want to see implemented in Lua? Add it to the [nvim-lua wishlist](https://github.com/nvim-lua/wishlist).
